...
export default {
    ...
    handler: async (
        ...
        try {
            ...
            // Initialize the NativeAuthProvider with the API URL from the network config
            ...
            let tokenAData = null;
            tokenAData = await walletProvider.getTokenData(pairContent.firstTokenID);
            let tokenBData = null;
            tokenBData = await walletProvider.getTokenData(pairContent.secondTokenID);
